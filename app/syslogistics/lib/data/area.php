...
class syslogistics_data_area {
    ...
    private function __getAreaFileContents()
    {
        ...
        base_kvstore::instance('ecos')->fetch('areaFileContents', $this->areaFileContents);
    ...
    public function __construct()
    {
        ...
        else
        {
            ...
            {
                $areaKvdataCache['area'] = $this->areaKvdata;
                $areaKvdataCache['areaIdPath'] = $this->areaIdPath;
                cacheobject::set('areaKvdata',$areaKvdataCache);
            }
        }
    }
