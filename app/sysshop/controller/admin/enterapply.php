...
class sysshop_ctl_admin_enterapply extends desktop_controller{
    ...
    public function doExamine($enterapplyId)
    {
        ...
        $shopinfo['corporate_identity_img'] = base_storager::modifier($shopinfo['corporate_identity_img'],'t' );
        $shopinfo['tissue_code_img'] = base_storager::modifier($shopinfo['tissue_code_img'],'t' );
        $shopinfo['tax_code_img'] = base_storager::modifier($shopinfo['tax_code_img'],'t' );
        $shopinfo['shopuser_identity_img'] = base_storager::modifier($shopinfo['shopuser_identity_img'],'t' );
        $shopinfo['license_img'] = base_storager::modifier($shopinfo['license_img'],'t' );
        $shopinfo['brand_warranty'] = base_storager::modifier($shopinfo['brand_warranty'],'t' );
