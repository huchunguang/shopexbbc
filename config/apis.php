...
return array(
    ...
    'routes' => array(
        ...
        //结算明细创建
        'clearing.detail.add' => ['uses' => 'sysclearing_api_createClearingDetail@add', 'version' => ['v1'], 'oauth' => true],
        ...
        //商品搜索
        'item.search' => ['uses' => 'sysitem_api_search_searchItems@getList', 'version'=>['v1']],
        //获取指定商品的货品
