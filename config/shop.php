...
return array(
    ...
    'shop' => array(
        ...
        'menu' => array(
            ...
            array('label'=>'开发者中心商家申请开通','display'=>false,'as'=>'topshop.open.developer.shop.apply','action'=>'topshop_ctl_open@applyForOpen','url'=>'applyDevelop.html','method'=>'get', 'middleware'=>['topshop_middleware_selfManagement']),
        )
    ),
